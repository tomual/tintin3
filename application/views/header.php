...
<head>
    <meta charset="utf-8">
    <title><?php echo get_title() ? get_title() . ' | ' : '' ?>Little Ticket Planet</title>
...
<body class="bg-primary">
    <div class="wrapper">
        <div class="container shadow py-5 pe-5 mt-5 bg-white">
            <div class="row">
                <div class="col-lg-4 py-5 text-center">
                    <svg class="svg-icon m-auto" viewBox="0 0 20 20">
                    ...
                    <b><a href="<?php echo base_url() ?>" class="text-reset text-decoration-none">Little Ticket Planet</a></b>
                    <?php if ($this->user) : ?>
